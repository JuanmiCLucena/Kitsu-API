...
<header id="head">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 px-0 mx-0 d-none d-lg-block"><img src="assets/images/dragon-ball.jpg" alt="Imagen 1" class="h-100"></div>
            <div class="col-lg-4 px-0 mx-0"><img src="assets/images/one-piece.jpg" alt="Imagen 2" class="h-100"></div>
            <div class="col-lg-4 px-0 mx-0 d-none d-lg-block"><img src="assets/images/naruto.jpg" alt="Imagen 3" class="h-100"></div>
        </div>
    </div>
</header>
<!-- /Header -->
...
<div class="jumbotron top-space">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 highlight">
                <div class="h-caption">
                    <h4><i class="fas fa-server"></i><a href="https://kitsu.docs.apiary.io/#" class="text-decoration-none text-info">KITSU API</a></h4>
                </div>
                <div class="h-body text-center">
